...
app.use(session({
    store: MongoStore.create({
        mongoUrl: "mongodb+srv://romerofabriciohxh:FDAs4RLea4VANsST@clustertest.ci9aoef.mongodb.net/",
        mongoOptions: {
...
mongoose.connect("mongodb+srv://romerofabriciohxh:FDAs4RLea4VANsST@clustertest.ci9aoef.mongodb.net/", {
    useNewUrlParser: true,
    useUnifiedTopology: true,
